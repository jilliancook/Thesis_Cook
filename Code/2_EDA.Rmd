...
voter_turnout <- ggplot() +
  stat_summary(data = data, mapping = aes(x = election_year, y = total_voter_turnout, color = "Total Turnout"), fun = mean, geom = "line") +
  stat_summary(data = data, mapping = aes(x = election_year, y = dem_voter_turnout, color = "Demgoraphic Turnout"), fun = mean, geom = "line") +
  stat_summary(data = data, mapping = aes(x = election_year, y = rep_voter_turnout, color = "Republican Voter Turnout"), fun = mean, geom = "line") +
...
ggplot(data, aes(x = Black_Total_Pop / Total_Pop, y = dem_vote_share_two_party)) +
  geom_point(alpha = 0.3) +
  facet_wrap(~election_year) +
  labs(title = "Black Population Share vs. Dem Vote Share")
